...
โค้ดเกมดัดแปลงจาก [UC Berkeley CS188](http://ai.berkeley.edu/) โปรดคงข้อความเครดิตในไฟล์ต้นฉบับไว้ และตรวจเงื่อนไขการเผยแพร่เฉลยที่ระบุในไฟล์ก่อนเปลี่ยน repository เป็นสาธารณะ
